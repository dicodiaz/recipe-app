...
**Recipe App** keeps track of all your recipes, ingredients and inventory. It allows you to:
...
```bash
git clone https://github.com/dicodiaz/recipe-app
```
